...
# note that the numpy directives is buggy. Example: class and init are not
#recognised as two entities for the autoclass_content=both here below
...
modindex_common_prefix = ["sequana_sphinxext."]
